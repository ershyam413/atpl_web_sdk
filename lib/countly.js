/** **********
* Atpl Web SDK
* https://github.com/Atpl/Atpl-sdk-web
*********** */
/**
 * Atpl object to manage the internal queue and send requests to Atpl server. More information on {@link https://resources.count.ly/docs/Atpl-sdk-for-web}
 * @name Atpl
 * @global
 * @namespace Atpl
 ...
 *  cly.src = "https://cdn.jsdelivr.net/Atpl-sdk-web/latest/Atpl.min.js";
...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
        typeof define === 'function' && define.amd ? define(['exports'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Atpl = global.Atpl || {}));
    ...
    var Atpl = globalThis.Atpl || {};

    /**
     * Array with list of available features that you can require consent for
     * @example
     * Atpl.features = ["sessions", "events", "views", "scrolls", "clicks", "forms", "crashes", "attribution", "users", "star-rating", "location", "apm", "feedback", "remote-config"];
     */
    // Feature ENUMS
    var featureEnums = {
        SESSIONS: "sessions",
     ...
     *1 - device ID was auto generated by Atpl
     *2 - device ID was temporarily given by Atpl
    ...
    /**
     * BoomerangJS and Atpl
     */
    var CDN = {
        BOOMERANG_SRC: "https://cdn.jsdelivr.net/npm/Atpl-sdk-web@latest/plugin/boomerang/boomerang.min.js",
        CLY_BOOMERANG_SRC: "https://cdn.jsdelivr.net/npm/Atpl-sdk-web@latest/plugin/boomerang/Atpl_boomerang.js",
    };
    ...
    */
    ...
    var AtplClass = /*#__PURE__*/_createClass(function AtplClass(ob) {
        _classCallCheck(this, AtplClass);
        var self = this;
        var global = !Atpl.i;
        ...
        var consents = {};
        for (var it = 0; it < Atpl.features.length; it++) {
            consents[Atpl.features[it]] = {};
        }

        this.initialize = function() {
            this.serialize = getConfig("serialize", ob, Atpl.serialize);
            this.deserialize = getConfig("deserialize", ob, Atpl.deserialize);
            this.getViewName = getConfig("getViewName", ob, Atpl.getViewName);
            this.getViewUrl = getConfig("getViewUrl", ob, Atpl.getViewUrl);
            this.getSearchQuery = getConfig("getSearchQuery", ob, Atpl.getSearchQuery);
            this.DeviceIdType = Atpl.DeviceIdType; // it is Atpl device Id type Enums for clients to use
            ...
            log(logLevelEnums.DEBUG, "initialize, 'getViewName' callback override provided:[" + (this.getViewName !== Atpl.getViewName) + "]");
            log(logLevelEnums.DEBUG, "initialize, 'getSearchQuery' callback override provided:[" + (this.getSearchQuery !== Atpl.getSearchQuery) + "]");
            ...
            log(logLevelEnums.INFO, "initialize, Atpl initialized");
            ...
            // if not check if developer provided any ID
                ...
                else if (Atpl.device_id !== undefined) {
                    deviceIdType = DeviceIdTypeInternalEnums.DEVELOPER_SUPPLIED;
                }
            }
            ...
            if (isBrowser) {
                document.documentElement.setAttribute("data-Atpl-useragent", currentUserAgentString());
            }
         ...
         * 
         * Resets Atpl to its initial state (used mainly to wipe the queues in memory).
         * Calling this will result in a loss of data
         */
        this.halt = function() {
            log(logLevelEnums.WARNING, "halt, Resetting Atpl");
            Atpl.i = undefined;
            global = !Atpl.i;
            ...
            // CONSENTS
            consents = {};
            for (var a = 0; a < Atpl.features.length; a++) {
                consents[Atpl.features[a]] = {};
            }
        ...
        * Atpl.group_features({all:["sessions","events","views","scrolls","clicks","forms","crashes","attribution","users"]});
        * //After this call Atpl.add_consent("all") to allow all features
        @example <caption>Grouping features</caption>
        * Atpl.group_features({
        *    activity:["sessions","events","views"],
        *    interaction:["scrolls","clicks","forms"]
        * });
        * //After this call Atpl.add_consent("activity") to allow "sessions","events","views"
        * //or call Atpl.add_consent("interaction") to allow "scrolls","clicks","forms"
        * //or call Atpl.add_consent("crashes") to allow some separate feature
        */
        ...
        * @param {string} feature - name of the feature, possible values, "sessions","events","views","scrolls","clicks","forms","crashes","attribution","users" or custom provided through {@link Atpl.group_features}
        ...
        */
        ...
        /**
        * Gets the current device id (of the AtplClass instance)
        ...
        * @param {string|array} feature - name of the feature, possible values, "sessions","events","views","scrolls","clicks","forms","crashes","attribution","users", etc or custom provided through {@link Atpl.group_features}
        */
        ...
        */
        ...
        var updateConsent = function updateConsent() {
            ...
            consentTimer = setTimeout(function() {
                var consentMessage = {};
                for (var i = 0; i < Atpl.features.length; i++) {
                    if (consents[Atpl.features[i]].optin === true) {
                        consentMessage[Atpl.features[i]] = true;
                    }
                    else {
                        consentMessage[Atpl.features[i]] = false;
                    }
                }
        ...
        this.enable_offline_mode = function() {
            ...
            // clear consents
            this.remove_consent_internal(Atpl.features, false);
            offlineMode = true;
            this.device_id = "[CLY]_temp_id";
        ...
        this.disable_offline_mode = function(device_id) {
            if (!offlineMode) {
                log(logLevelEnums.WARNING, "disable_offline_mode, Atpl was not in offline mode.");
                return;
            }
        ...
        * */
        ...
        /**
        * Report custom event
        * @param {Object} event - Atpl {@link Event} object
        ...
        * */
         ...
         *  @memberof Atpl._internals
         *  @param {Event} event - Atpl event
         *  @param {String} eventIdOverride - Atpl event ID
         */
        ...
        * */
        ...
        /**
        * End timed event
        * @param {string|object} event - event key if string or Atpl event same as passed to {@link Atpl.add_event}
        * */
        ...
        * @param {Object} user - Atpl {@link UserDetails} object
        ...
        * @namespace Atpl.userData
        * @name Atpl.userData
        * @example
        * //set custom key value property
        * Atpl.userData.set("twitter", "hulk@rowboat");
        * //create or increase specific number property
        * Atpl.userData.increment("login_count");
        * //add new value to array property if it is not already there
        * Atpl.userData.push_unique("selected_category", "IT");
        ...
        * */
        this.track_errors = function(segments) {
            ...
            // Indicated that for this instance of the Atpl error tracking is enabled
            Atpl.i[this.app_key].tracking_crashes = true;
        ...
        * */
        ...
        /**
        * Collect possible user data from submitted forms. Add cly_user_ignore class to ignore inputs in forms or cly_user_{key} to collect data from this input as specified key, as cly_user_username to save collected value from this input as username property. If not class is provided, Atpl SDK will try to determine type of information automatically.
        * @param {Object=} parent - DOM object which children to track, by default it is document body
        ...
        * @param {Object} AtplFeedbackWidget - it is the widget object retrieved from get_available_feedback_widgets
        * @param {Object} AtplWidgetData - it is the widget data object retrieved from getFeedbackWidgetData
        ...
        *   }
        * */
        this.reportFeedbackWidgetManually = function(AtplFeedbackWidget, AtplWidgetData, widgetResult) {
            if (!this.check_consent(featureEnums.FEEDBACK)) {
                return;
            }
            if (!(AtplFeedbackWidget && AtplWidgetData)) {
                log(logLevelEnums.ERROR, "reportFeedbackWidgetManually, Widget data and/or Widget object not provided. Aborting.");
                return;
            }
            if (!AtplFeedbackWidget._id) {
            ...
            log(logLevelEnums.INFO, "reportFeedbackWidgetManually, Providing information about user with, provided result of the widget with  ID: [ " + AtplFeedbackWidget._id + " ] and type: [" + AtplFeedbackWidget.type + "]");

            // type specific checks to see if everything was provided
            var props = [];
            var type = AtplFeedbackWidget.type;
            var eventKey;
            if (type === "nps") {
                if (widgetResult) {
            ...
            var event = {
                ...
                count: 1,
                segmentation: {
                    widget_id: AtplFeedbackWidget._id,
        ...
        */
        this.initializeRatingWidgets = function(enableWidgets) {
            ...
            var stickers = document.getElementsByClassName("Atpl-feedback-sticker");
        ...
        * */
        this.enableRatingWidgets = function(params) {
            ...
            if (offlineMode) {
                ...
                loadCSS(this.url + "/star-rating/stylesheets/Atpl-feedback-web.css");
        ...
        * @param {Object} AtplFeedbackWidget - Widget object, retrieved from 'get_available_feedback_widgets'
        * @param {Function} callback - Callback function with two parameters, 1st for returned widget data, 2nd for error
        * */
        this.getFeedbackWidgetData = function(AtplFeedbackWidget, callback) {
            if (!AtplFeedbackWidget.type) {
                log(logLevelEnums.ERROR, "getFeedbackWidgetData, Expected the provided widget object to have a type but got: [" + JSON.stringify(AtplFeedbackWidget) + "], aborting.");
                return;
            }
            log(logLevelEnums.INFO, "getFeedbackWidgetData, Retrieving data for: [" + JSON.stringify(AtplFeedbackWidget) + "], callback function is provided:[" + !!callback + "]");
            if (!this.check_consent(featureEnums.FEEDBACK)) {
                if (callback) {
                    callback(null, new Error("Consent for feedback not provided."));
                }
            ...
            if (AtplFeedbackWidget.type === "nps") {
                url += "/o/surveys/nps/widget";
            }
            else if (AtplFeedbackWidget.type === "survey") {
                url += "/o/surveys/survey/widget";
            }
            else if (AtplFeedbackWidget.type === "rating") {
                url += "/o/surveys/rating/widget";
            }
            else {
                log(logLevelEnums.ERROR, "getFeedbackWidgetData, Unknown type info: [" + AtplFeedbackWidget.type + "]");
                return;
            }
        ...
        * */
        this.present_feedback_widget = function(presentableFeedback, id, className, feedbackWidgetSegmentation) {
            ...
            try {
                ...
                // (at least until we add new type in future)
                    ...
                    loadCSS(this.url + "/surveys/stylesheets/Atpl-surveys.css");
                ...
                iframe.src = url;
                iframe.name = "Atpl-" + feedbackWidgetFamily + "-iframe";
                iframe.id = "Atpl-" + feedbackWidgetFamily + "-iframe";
                var initiated = false;
                iframe.onload = function() {
                    ...
                    if (initiated) {
                        ...
                        document.getElementById("Atpl-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id).style.display = "none";
                ...
                var wrapper = document.getElementsByClassName("Atpl-" + feedbackWidgetFamily + "-wrapper");
                ...
                wrapper.className = "Atpl-" + feedbackWidgetFamily + "-wrapper";
                wrapper.id = "Atpl-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id;
                ...
                if (presentableFeedback.type === "rating") {
                    ...
                    ratingsOverlay.className = "Atpl-ratings-overlay";
                    ratingsOverlay.id = "Atpl-ratings-overlay-" + presentableFeedback._id;
                    ...
                    add_event_listener(document.getElementById("Atpl-ratings-overlay-" + presentableFeedback._id), "click", function() {
                        document.getElementById("Atpl-ratings-wrapper-" + presentableFeedback._id).style.display = "none";
                    });
                }
                ...
                if (presentableFeedback.type === "survey") {
                    ...
                    document.getElementById("Atpl-" + feedbackWidgetFamily + "-wrapper-" + presentableFeedback._id).style.display = "block";
            ...
            function showSurvey(feedback) {
                document.getElementById("Atpl-surveys-wrapper-" + feedback._id).style.display = "block";
                document.getElementById("csbg").style.display = "block";
            }
            ...
            function showRatingForFeedbackWidget(feedback) {
                ...
                if (!feedback.appearance.hideS) {
                    ...
                    sticker.className = "Atpl-feedback-sticker  " + feedback.appearance.position + "-" + feedback.appearance.size;
                    sticker.id = "Atpl-feedback-sticker-" + feedback._id;
                    document.body.appendChild(sticker);

                    // sticker event handler
                    add_event_listener(document.getElementById("Atpl-feedback-sticker-" + feedback._id), "click", function() {
                        document.getElementById("Atpl-ratings-wrapper-" + feedback._id).style.display = "flex";
                        document.getElementById("csbg").style.display = "block";
                    });
                }
                ...
                add_event_listener(document.getElementById("Atpl-feedback-close-icon-" + feedback._id), "click", function() {
                    document.getElementById("Atpl-ratings-wrapper-" + feedback._id).style.display = "none";
                    document.getElementById("csbg").style.display = "none";
                });
            }
        };
        ...
        function processWidget(currentWidget, hasSticker) {
            ...
            var isDuplicate = !!document.getElementById("Atpl-feedback-sticker-" + currentWidget._id);
            if (isDuplicate) {
            ...
            try {
                ...
                wrapper.className = "Atpl-iframe-wrapper";
                wrapper.id = "Atpl-iframe-wrapper-" + currentWidget._id;
                // create close icon for iframe popup
                var closeIcon = document.createElement("span");
                closeIcon.className = "Atpl-feedback-close-icon";
                closeIcon.id = "Atpl-feedback-close-icon-" + currentWidget._id;
                closeIcon.innerText = "x";

                // create iframe
                var iframe = document.createElement("iframe");
                iframe.name = "Atpl-feedback-iframe";
                iframe.id = "Atpl-feedback-iframe";
                ...
                wrapper.appendChild(iframe);
                add_event_listener(document.getElementById("Atpl-feedback-close-icon-" + currentWidget._id), "click", function() {
                    document.getElementById("Atpl-iframe-wrapper-" + currentWidget._id).style.display = "none";
                ...
                if (hasSticker) {
                    ...
                    sticker.className = "Atpl-feedback-sticker  " + currentWidget.trigger_position + "-" + currentWidget.trigger_size;
                    sticker.id = "Atpl-feedback-sticker-" + currentWidget._id;
                    ...
                    add_event_listener(document.getElementById("Atpl-feedback-sticker-" + currentWidget._id), "click", function() {
                        document.getElementById("Atpl-iframe-wrapper-" + currentWidget._id).style.display = "block";
        ...
        function heartBeat() {
            ...
            var i = 0;
            // process queue
            if (global && typeof Atpl.q !== "undefined" && Atpl.q.length > 0) {
                var req;
                var q = Atpl.q;
                Atpl.q = [];
                for (i = 0; i < q.length; i++) {
                    ...
                    if (typeof req === "function") {
                        ...
                        else if (typeof Atpl[req[arg]] === "function") {
                            Atpl[req[arg]].apply(Atpl, req.slice(arg + 1));
                        }
                    }
                }
            }
        ...
        function log(level, message) {
            if (self.debug && typeof console !== "undefined") {
                ...
                var log = level + "[Atpl] " + message + extraArguments;
        ...
        * @namespace Atpl._internals
        * @name Atpl._internals
        */
        this._internals = {
        ...
        /**
         * Atpl health check request sender
         */
        ...
        // initialize Atpl Class
        this.initialize();
    });

    Atpl.AtplClass = AtplClass;

    /**
     * Initialize Atpl object
     * @param {Object} conf - Atpl initialization/config {@link Init} object with configuration options
     * @param {string} conf.app_key - app key for your app created in Atpl
     * @param {string} conf.device_id - to identify a visitor, will be auto generated if not provided
     * @param {string} conf.url - your Atpl server url, you can use your server URL or IP here
     ...
     * @returns {Object} Atpl tracker instance
     * @example
     * Atpl.init({
     *   //provide your app key that you retrieved from Atpl dashboard
     ...
     * });
     */
    Atpl.init = function(conf) {
        conf = conf || {};
        if (Atpl.loadAPMScriptsAsync && apmLibrariesNotLoaded) {
            apmLibrariesNotLoaded = false;
            initAfterLoadingAPM(conf);
            return;
        }
        var appKey = conf.app_key || Atpl.app_key;
        if (!Atpl.i || !Atpl.i[appKey]) {
            var inst = new AtplClass(conf);
            if (!Atpl.i) {
                Atpl.i = {};
                for (var key in inst) {
                    Atpl[key] = inst[key];
     ...
     *     force_post: false
     *     getFeedbackWidgetData: ƒ (AtplFeedbackWidget, callback)
     *     getSearchQuery: ƒ ()
     *     getViewName: ƒ ()
     *     getViewUrl: ƒ ()
     ...
     *     customSourceAtplBoomerang: CDN.CLY_BOOMERANG_SRC or basically the cdn link to Atpl_boomerang.js
     ...
     *     reportFeedbackWidgetManually: ƒ (AtplFeedbackWidget, AtplWidgetData, widgetResult)
     ...
     * @param {Object} conf - Atpl config object.
     */
    function initAfterLoadingAPM(conf) {
        ...
        var AtplBoomerangScript = document.createElement("script");

        // Set boomerang script attributes
        boomerangScript.async = true;
        AtplBoomerangScript.async = true;

        // Set boomerang script source
        boomerangScript.src = Atpl.customSourceBoomerang || CDN.BOOMERANG_SRC;
        AtplBoomerangScript.src = Atpl.customSourceAtplBoomerang || CDN.CLY_BOOMERANG_SRC;

        // Append boomerang script to the head
        document.getElementsByTagName("head")[0].appendChild(boomerangScript);
        document.getElementsByTagName("head")[0].appendChild(AtplBoomerangScript);
        var boomLoaded = false;
        var AtplBoomLoaded = false;
        boomerangScript.onload = function() {
            boomLoaded = true;
        };
        AtplBoomerangScript.onload = function() {
            AtplBoomLoaded = true;
        };
        var timeoutCounter = 0;
        var intervalDuration = 50;
        var timeoutLimit = 1500; // TODO: Configurable? Mb with Atpl.apmScriptLoadTimeout?
        // init Atpl only after boomerang is loaded
        var intervalID = setInterval(function() {
            timeoutCounter += intervalDuration;
            if (boomLoaded && AtplBoomLoaded || timeoutCounter >= timeoutLimit) {
                if (Atpl.debug) {
                    var message = "BoomerangJS loaded:[" + boomLoaded + "], Atpl_boomerang loaded:[" + AtplBoomLoaded + "].";
                    if (boomLoaded && AtplBoomLoaded) {
    ...
    */
    ...
    function getConfig(key, ob, override) {
        ...
        else if (typeof Atpl[key] !== "undefined") {
            return Atpl[key];
        }
        return override;
    }
    ...
    function dispatchErrors(error, fatality, segments) {
        // Check each instance like Atpl.i[app_key_1], Atpl.i[app_key_2] ...
        for (var app_key in Atpl.i) {
            // If track_errors is enabled for that instance
            if (Atpl.i[app_key].tracking_crashes) {
                // Trigger recordError function for that instance
                Atpl.i[app_key].recordError(error, fatality, segments);
            }
        }
    }
    ...
    function add_event_listener(element, type, listener) {
        ...
        if (element === null || typeof element === "undefined") {
            ...
            if (checkIfLoggingIsOn()) {
                // eslint-disable-next-line no-console
                console.warn("[WARNING] [Atpl] add_event_listener, Can't bind [" + type + "] event to nonexisting element");
            }
            return;
        }
    ...
    if (isBrowser) {
        window.addEventListener("storage", function (e) {
            ...
            if (Atpl.i && Atpl.i[appKey]) {
                Atpl.i[appKey].onStorageChange(key, e.newValue);
            }
        });
    }
    ...
    function showLoader() {
        ...
        if (!loader) {
            ...
            document.body.onload = function() {
                ...
                if (Atpl.showLoaderProtection) {
                    if (checkIfLoggingIsOn()) {
                        // eslint-disable-next-line no-console
                        console.warn("[WARNING] [Atpl] showloader, Loader is already on");
                    }
                    return;
                }
                try {
                    ...
                    if (checkIfLoggingIsOn()) {
                        // eslint-disable-next-line no-console
                        console.error("[ERROR] [Atpl] showLoader, Body is not loaded for loader to append: " + e);
                    }
                }
            };
        }
    ...
    /**
     *  Checks if debug is true and console is available in Atpl object
     *  @memberof Atpl._internals 
     * @returns {Boolean} true if debug is true and console is available in Atpl object
     */
    function checkIfLoggingIsOn() {
        // check if logging is enabled
        if (Atpl && Atpl.debug && typeof console !== "undefined") {
            return true;
        }
        return false;
    }
    ...
    function hideLoader() {
        ...
        Atpl.showLoaderProtection = true;
        var loader = document.getElementById("cly-loader");
        if (loader) {
    ...
    * */
    Atpl.deserialize = function(data) {
        if (data === "") {
        ...
        try {
            ...
            if (checkIfLoggingIsOn()) {
                // eslint-disable-next-line no-console
                console.warn("[WARNING] [Atpl] deserialize, Could not parse the file:[" + data + "], error: " + e);
            }
        }
        return data;
    };
